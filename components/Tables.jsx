...
function Tables(props) {
    ...
    return (
      <>
        ...
        <Box style={{ display: "flex", flexDirection: "row", width: "95%", justifyContent: "space-between" }}>
          <Pagination total={1} limit={limit} page={1} onChange={() => {}} />
          <ButtonAdd tableName={tableName} columns={columnHeaders} />
        </Box>

        <SkeletonStructure loading={loading} setLoading={setLoading}/>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <Box style={{ display: "flex", flexDirection: "row", width: "95%", justifyContent: "space-between" }}>
        <Pagination total={totalPages} limit={limit} page={page} onChange={setPage} />
        <ButtonAdd tableName={tableName} columns={columnHeaders} />
      </Box>
